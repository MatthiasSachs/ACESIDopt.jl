...
output_file = joinpath(output_dir, string("ptd_ace_silicon_test", plot_tag, ".png"))
...
for i in 1:n_replicas
    ...
    output_filename = joinpath(data_output_dir, "replica_$(i)_T$(round(Int, temperatures[i]))K_samples$(plot_tag).xyz")

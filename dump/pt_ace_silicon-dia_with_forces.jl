...
raw_data["init"] = ExtXYZ.load("/Users/msachs2/Documents/GitHub-2/ACESIDopt.jl/data/Si-diamond-ref.xyz")
...
println("\n Serial Parallel Tempering Parameters:")
...
output_file = joinpath(output_dir, string("pt_ace_silicon_test", run_tag, ".png"))
...
for i in 1:n_replicas
    ...
    add_energy_forces(replicas[i], model)

...
#%%
raw_data["test-large-0"] = ExtXYZ.load("/Users/msachs2/Documents/GitHub-2/testASECalculators/results/glycine_remd_parallel2/replica_0_val_1000frames.xyz")
raw_data["test-large-1"] = ExtXYZ.load("/Users/msachs2/Documents/GitHub-2/testASECalculators/results/glycine_remd_parallel2/replica_1_val_1000frames.xyz")
raw_data["test-large-2"] = ExtXYZ.load("/Users/msachs2/Documents/GitHub-2/testASECalculators/results/glycine_remd_parallel2/replica_2_val_1000frames.xyz")
raw_data["test-large-3"] = ExtXYZ.load("/Users/msachs2/Documents/GitHub-2/testASECalculators/results/glycine_remd_parallel2/replica_3_val_1000frames.xyz")
...
for i in 1:length(test_error)
    ...
    for j in d_ind
        ...
        @printf("Large test set error for model iter %d: %.4f eV\n", i, large_test_error[j][end])
    end
end

# model_filename = joinpath(models_dir, "model_iter_$(lpad(1, 3, '0')).ace")
# model = ACEpotentials.load_model(model_filename)
